                  ...
                  <div class="col-sm-8">
                    ...
                    <div class="d-flex justify-content-between">
                      <div class="form-check">
                        <Field id="public" name="公開" as="checkbox" class="form-check-input mb-3"
                        :class="{ 'is-invalid': errors['公開'] }"
                        rules="required" v-model="innertempArticle.isPublic"></Field>
                        <label class="form-check-label" for="public">公開</label>
                        <span class="text-danger">*</span>
                        <ErrorMessage name="公開" class="invalid-feedback"></ErrorMessage>
                      </div>
