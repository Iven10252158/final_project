...
<div class="container">
    <section class="row g-0 flex-column-reverse flex-lg-row mt-0">
        <div class="col-12 col-lg-6 d-flex align-items-center">
            <ul data-aos="fade-right" data-aos-duration="1000" class="list-unstyled px-sm-5 pt-3">
                <li class="h3">消失的鐵道 -- 眠月線</li>
                <li class="p-md-2">眠月線，1915年通車，日治時代作為木材運輸路線。是阿里山森林鐵路的支線之一，從阿里山車站至石猴車站，全長大約9.2公里。民國72年發展為光觀產業，使用古老的蒸汽火車載客。
    ...
    <section class="row g-0 flex-column flex-lg-row mt-0">
        ...
        <div class="col-12 col-lg-6 d-flex align-items-center">
            <ul data-aos="fade-left" data-aos-duration="1000" class="list-unstyled px-sm-5 pt-3">
                ...
                <li class="p-md-2">有人說嘉明湖是「天使的眼淚」、是「上帝遺留在人間的藍寶石」，布農族人稱它為「月亮的鏡子」。這些浪漫的形容詞是許多人對嘉明湖的第一印象。
