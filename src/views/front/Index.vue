<template>
    ...
    <div class="container">
        <div class="row g-0 flex-column-reverse flex-lg-row mb-0">
            <div class="col-lg-6 d-flex align-items-center">
                <div data-aos="fade-right" data-aos-duration="1500" class="px-3 pe-lg-4 pt-3 mb-0">
                    <h3>消失的鐵道 -- 眠月線</h3>
                    <p class="fs-6 lh-lg mb-0">1915年通車，日治時代作為木材運輸路線。是阿里山森林鐵路的支線之一，全長大約9.2公里。民國72年發展為光觀產業，使用古老的蒸汽火車載客。 民國88年九二一地震震毀了阿里山的森林鐵路，耗時大量的經費與時間，民國98年修復完成，還沒通車就遭遇八八風災，破壞了鐵路的地基，復駛之路遙遙無期。 眠月線百年來歷經滄桑，路線停駛後長年封印於塔山。民國109年初解除入山管制，在社群媒體帶動曝光下，眠月線美景再度成為熱門打卡景點。</p>
                    <router-link to="/products" class="indexBtn btn btn-outline-primary rounded-0 mt-3 px-5 mb-0">
                        <p class="mb-0">查看更多</p>
                    </router-link>
                </div>
            </div>
        ...
        <div class="row g-0 flex-column flex-lg-row mt-3 mt-lg-0 mb-0">
            ...
            <div class="col-lg-6 d-flex align-items-center">
                <div data-aos="fade-right" data-aos-duration="1500" class="px-3 ps-lg-4 pt-3">
                    <h3>天使的眼淚 -- 嘉明湖</h3>
                    <p class="fs-6 lh-lg mb-0">有人說嘉明湖是「天使的眼淚」、是「上帝遺留在人間的藍寶石」，布農族人稱它為「月亮的鏡子」。這些浪漫的形容詞是許多人對嘉明湖的第一印象。
                        海拔3310公尺，是台灣第二高的高山湖泊，佔地面積1.9公頃，是近年來著名的台灣深山景點。但鮮為人知的是嘉明湖是冰河所遺留的冰斗地形，這也說明了，台灣曾經經歷過冰河時期，只是也許那時候還沒有台灣而已。</p>
                    <router-link to="/products" class="indexBtn btn btn-outline-primary rounded-0 mt-3 px-5 mb-0">
                        <p class="mb-0">查看更多</p>
                    </router-link>
                </div>
    ...
    <div class="bg-cover article my-5 pt-3 d-flex justify-content-center align-items-center" style="background-image:url('https://storage.googleapis.com/vue-course-api.appspot.com/iven_vue3_course/1627614691162.jpeg?GoogleAccessId=firebase-adminsdk-zzty7%40vue-course-api.iam.gserviceaccount.com&Expires=1742169600&Signature=mB%2FBpIMJuepUUVnYqH%2BkkNvYBMFskq3CXPPdzhH5pRvzyVhTwNZedXs6CpKbPInWroFehAjdf9UhQ8VCWqUZJrhdeC6wyxv8mqdOujcmAZxPKQy5rZNZERs7O4TcAjEobx3GUpDpnnecLkDTgU6rtIoqoFkULCve%2BB1HkNbXRo06yWYEylr7odDjsm1r3uHqhB6u1ZpXjyvGzyQIXrNLUVZ7983Pr%2BjVJhpeLgsuXjvZFqoPbLzT2CG3YgPDS4Tyj6G3oKuwe4yDvKVde%2Be0AikmcDOsBFUvlRtb95daOSjhrEw0P%2BWsaoRL5W8RMyjL5RHes31ryCk%2FE8ox5fPVNw%3D%3D');height:200px">
        <ul class="list-unstyled rounded text-center text-white p-3 LNT-warning">
