    ...
    <div class="container">
        <div class="row g-0 flex-column-reverse flex-lg-row mb-0">
            <div class="col-lg-6 content d-flex align-items-center">
                <ul data-aos="fade-right" data-aos-duration="1500" class="list-unstyled px-lg-5 pt-3 mb-0">
                    ...
                    <li>
                        <router-link to="/products" class="indexBtn btn btn-outline-primary rounded-0 mt-3 px-5">
                            <p class="mb-0">查看更多</p>
                        </router-link>
                    </li>
                </ul>
        ...
        <div class="row g-0 flex-column flex-lg-row mt-3 mt-lg-0 mb-0">
            ...
            <div class="col-lg-6 content d-flex align-items-center">
                <ul data-aos="fade-right" data-aos-duration="1500" class="list-unstyled px-lg-5 pt-3">
